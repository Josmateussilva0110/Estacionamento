import {
  MapPin, Phone, Settings, DollarSign, Building2
} from "lucide-react"
...
type StepSummaryProps = Pick<FormStepProps<ParkingFormData>, "watch">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <SummaryCard
          ...
          items={[
            ...
            ["Horário", `${data.contacts.openingHours.start} às ${data.contacts.openingHours.end}`],
          ]}
        />
      </div>
