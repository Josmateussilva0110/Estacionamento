    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        ...
        {!isPassword && rightIcon && (
          <div className="absolute right-3 top-1/2 -translate-y-1/2 text-blue-300 pointer-events-none z-10">
            {rightIcon}
          </div>
        )}
        ...
        {isPassword && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-blue-300 z-10"
          >
